...
- Sistema de **premios con código QR**
- **Panel docente** con lector QR integrado
- Envío automático de resultados a Google Sheets (opcional)
- Diseño responsive (móvil, tablet, PC)
- Botón de impresión de informe

## Despliegue
Publicado con GitHub Pages. Un único archivo `index.html` sin dependencias de servidor.
